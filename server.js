...
const mockEvents = {
    events: [
        { title: 'Bootcamp Day 1', id: 1, description: 'Microservices on Cloud' },
        { title: 'Bootcamp Day 2', id: 2, description: 'Docker and Kubernetes' }
    ]
};
...
app.delete('/event', (req, res) => {
    // delete a new object from the json data and add an id
    const ev = { 
        title: req.body.title, 
        description: req.body.description,
        id : mockEvents.events.length + 1
